...
// Sources: live Google Docs (refund + tagging) fetched at sync time.
// One cascade card per dated entry; newest first; channel-tagged (Email/Call/Team).
window.KB_RAW_CASCADES = [
  ...
  },
  {
    ...
    "status": "current",
    "desc": "🔵 ACTIVE HANDLING Please be advised that we now have a new Amazon, Ebay, Walmart 2026 tracking sheet, which is located inside the same existing link. Kindly mak",
    "tags": [
      "Entire Team"
    ],
    "cascadedBy": "",
