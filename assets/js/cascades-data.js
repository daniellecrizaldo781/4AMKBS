...
window.KB_RAW_CASCADES = [
  {
    ...
    "desc": "Just a quick reminder regarding unsubscribe requests from our marketing emails.   If a customer replies to one of our marketing emails simply asking to be remov",
  ...
  {
    "id": "do-not-assist-amazon-walmart-or-ebay-customers-directly",
  ...
  {
    "id": "new-process-for-walmart-escalation-tickets",
  ...
  {
    "id": "new-audiologist-training-portal",
  ...
  {
    "id": "oha-double-dome-tips-customer-complaints-tracking",
  ...
  {
    "id": "refund-flow-test-oricle-hearing",
    "title": "Update: Oricle Hearing | Refund Flow Test Update",
    "desc": "Effective immediately, please pause sending the refund request link.   For now, let’s revert to our standard return process, which includes: * Providing the ret",
    "category": "OHA / Hearing Aids",
    "product": "",
    "status": "current",
  ...
  {
    "id": "assisting-customers-with-oricle-upgrades-following-hearing-c",
  ...
  {
    "id": "specialist-consultation-calendar-links",
  ...
  {
    "id": "manual-order-creation-handling-for-splash-foam-spray",
  ...
  {
    "id": "placing-an-order-via-sticky",
    "title": "Update: Placing an order via Sticky",
    "desc": "Please refrain placing orders via our websites.  Effective immediately, all orders (inbound sales, assisting customers in placing orders) should be created in S",
    "category": "Order Processing",
    "product": "",
    "status": "current",
    "date": "June 19, 2026",
  ...
  {
    "id": "order-processing-update-campaign-id-reference-upsell-reminde",
  ...
  {
    "id": "oha-double-dome-tips-fit-insertion-assistance",
  ...
  },
  {
    ...
    "desc": "Effective immediately, when manually creating a 50% Green Return via Redo, please ensure that you manually adjust the fee to 50% before processing.   This adjus",
    "category": "Returns & Refunds",
    "product": "",
    "status": "current",
    "date": "June 12, 2026",
  ...
  {
    "id": "bj-warehouse-new-ny-warehouse-shipping-delay-compensation",
  ...
  {
    "id": "internal-notes-in-shiphero",
    "title": "Update: Internal Notes in Shiphero",
    "desc": "Quick update regarding leaving internal notes in Shiphero.   Please ensure that all notes are added under Order History using the “+” button. Kindly avoid placi",
    "category": "Shipping & Fulfillment",
    "product": "",
    "status": "current",
    "date": "June 06, 2026",
  ...
  {
    "id": "marketing-ticket-manual-tagging",
    "title": "Update: Marketing Ticket Manual Tagging",
    "desc": "Dedicated folders for Admin Tickets have been created. All tracked and for-tracking tickets will automatically be filtered into these folders.   To ensure accur",
    "category": "Tagging & Tracking",
    "product": "",
    "status": "current",
    "date": "June 01, 2026",
  ...
  {
    "id": "proper-tagging-for-tickets-with-multiple-concerns",
    "title": "Reminder: Proper Tagging for Tickets with Multiple Concerns",
    "desc": "Just a quick reminder on the importance of proper tagging in Zendesk.   When you encounter a ticket with multiple concerns, please make sure that all concerns a",
    "category": "Tagging & Tracking",
    "product": "",
    "status": "current",
    "date": "June 15, 2026",
